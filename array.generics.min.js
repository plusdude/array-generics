...
return c},reduceRight:function(a,c){var b,e,d;b=k(this);n(a);e=m!==c;for(d=(b.length>>>0)-1;-1<d;--d)d in b&&(e?c=a(c,b[d],d,b):(c=b[d],e=!0));s(e);return c}};for(var p in h)h.hasOwnProperty(p)&&(x(p)||(g.prototype[p]=h[p]),t(p));g.isArray=g.isArray||w;"concat join slice pop push reverse shift sort splice unshift".split(" ").forEach(t);try{g.slice({})}catch(z){g.prototype.slice=v}})(this,1/0);
